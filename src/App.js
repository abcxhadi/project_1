...
const ShafeerPortfolio = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <Route className="w-10 h-10 text-yellow-500" />,
  ...
  const experienceItems = [
    { title: 'Years of Experience', value: '10+', icon: <Award className="w-8 h-8 text-yellow-500" /> },
    { title: 'Clients Served', value: '5000+', icon: <Users className="w-8 h-8 text-yellow-500" /> },
    { title: 'Kilometers Driven', value: '500k+', icon: <Car className="w-8 h-8 text-yellow-500" /> },
    { title: 'VIP Clients', value: '250+', icon: <Star className="w-8 h-8 text-yellow-500" /> }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col relative">
      ...
      {/* HEADER */}
      <header className="bg-gradient-to-b from-gray-800 to-gray-700 text-white shadow-lg">
        ...
        <nav className="py-3 border-t border-gray-600 bg-gray-700">
          <div className="container mx-auto flex justify-center">
            <ul className="flex flex-wrap justify-center space-x-2 md:space-x-6 px-4">
              <li className="my-1">
                <a 
                  href="#services" 
                  className="block px-4 py-2 rounded-full bg-gray-600 hover:bg-yellow-500 hover:text-gray-900"
                >
                  Services
                </a>
              </li>
      ...
      {showFloatingButton && (
        <div className="fixed bottom-6 right-6 z-50">
          <button 
            ...
            className="flex items-center justify-center bg-black text-white p-4 rounded-full shadow-lg hover:bg-gray-800 transition-colors duration-300"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="md:flex">
              ...
              <div className="bg-gray-800 text-white p-6 md:p-8 md:w-1/3">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                    <button 
                      type="button"
                      onClick={handleWhatsAppContact}
                      className="w-full py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-700 flex items-center justify-center transition-colors shadow-md font-medium text-lg"
                    >
