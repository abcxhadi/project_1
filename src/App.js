...
const ShafeerPortfolioMinimalist = () => {
  ...
  const services = [
    {
      ...
      description: 'Premium full-day chauffeur service.',
      duration: 'Full Day',
      price: '800 AED'
    },
    {
      ...
      description: 'Professional half-day service for business or leisure.',
      duration: 'Half Day',
      price: '400 AED'
    },
    {
      ...
      description: 'Reliable airport or city transfers with style.',
  ...
  const experienceItems = [
    { title: 'Years of Experience', value: '10+', icon: <Award className="w-6 h-6 text-amber-400" /> },
    { title: 'Happy Clients', value: '500+', icon: <CheckCircle className="w-6 h-6 text-amber-400" /> },
    { title: 'Trips Completed', value: '1000+', icon: <Car className="w-6 h-6 text-amber-400" /> },
    { title: 'Awards', value: '5+', icon: <Award className="w-6 h-6 text-amber-400" /> }
  ];

  const qualitiesItems = [
    { title: 'Professional', description: 'Highly trained and experienced.', icon: <CheckCircle className="w-6 h-6 text-amber-400" /> },
    { title: 'Reliable', description: 'Always on time.', icon: <Clock className="w-6 h-6 text-amber-400" /> },
    { title: 'Luxury', description: 'Top-tier vehicles and service.', icon: <Star className="w-6 h-6 text-amber-400" /> }
  ];
